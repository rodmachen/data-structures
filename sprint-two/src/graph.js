...
// the value passed to contains is represented in the graph.
...
Graph.prototype.removeEdge = function(fromNode, toNode) {
  var toNodeIndex = this.nodes[fromNode].indexOf(toNode);
  this.nodes[fromNode].splice(toNodeIndex, 1);
  var fromNodeIndex = this.nodes[toNode].indexOf(fromNode);
